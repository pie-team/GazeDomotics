    ...
    if gaze.is_blinking():
        ...
        if RegardGauche >= 17:				# il faut maintenir le regard pendant au moins 30 iterations
            ...
            if retour_etat_SaM == 0:			# si eteinte
                ...
                couleur_texte_SAM = [0, 0, 0]	# texte noir
            else:							# sinon
                commandeKNX.SAM_eteindre()	# eteint
                couleur_SAM = [0, 0, 0]		# couleur de fond noir
                couleur_texte_SAM = [0, 255, 255]	# couleur texte jaune
        ...
        if RegardDroite >= 17:				# il faut maintenir le regard pendant au moins 30 iterations
            ...
            if retour_etat_centre == 0:		# si eteinte
                ...
                couleur_texte_centre_salon = [0, 0, 0]	# texte noir
            else:							# sinon
                commandeKNX.Centre_eteindre()			# eteint
                couleur_centre_salon = [0, 0, 0]		# couleur de fond noir
                couleur_texte_centre_salon = [0, 255, 255]	# couleur texte jaune
