...
###############  CREATION DES REPERES POUR RETOUR POSITION REGARD  ################## 
    ...
    erreur_relative = gaze.coefficient_de_variation()		# releve erreur relative
    
 """Valeurs estimées pour vvvvv un écran 1920px de   vvvv largeur pour compenser """
    position_x_marqueur = -5485 * ratio_horizontal + 3840	# calcul ordonnee du cercle
    print("ratio:",ratio_horizontal,"position marqueur:", position_x_marqueur)
    diametre_marqueur = erreur_relative * 100 				# calcul diametre du cercle
