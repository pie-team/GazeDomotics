...
if __name__ == "__main__":
    ...
    if mode == "+":
        bwd(1050, 1680, "GazeDomotics", "HEY", wait_time=1000)
        bwd(1050, 1680, "GazeDomotics", "SLT", wait_time=3000)
        bwd(1050, 1680, "GazeDomotics", "CV?", wait_time=3000)
        bwd(1050, 1680, "GazeDomotics", "READY?", wait_time=3000)
        bwd(1050, 1680, "GazeDomotics", "+", wait_time=3000, mode="location", location=(1660, 525))
        bwd(1050, 1680, "GazeDomotics", "| CENTRE |", wait_time=3000)
        bwd(1050, 1680, "GazeDomotics", "+", wait_time=3000, mode="location", location=(1660, 20))
        bwd(1050, 1680, "GazeDomotics", "| CENTRE |", wait_time=3000)
        bwd(1050, 1680, "GazeDomotics", "+", wait_time=3000, mode="location", location=(840, 20))
        bwd(1050, 1680, "GazeDomotics", "| CENTRE |", wait_time=3000)
        bwd(1050, 1680, "GazeDomotics", "+", wait_time=3000, mode="location", location=(20, 20))
        bwd(1050, 1680, "GazeDomotics", "| CENTRE |", wait_time=3000)
        bwd(1050, 1680, "GazeDomotics", "+", wait_time=3000, mode="location", location=(20, 525))
        bwd(1050, 1680, "GazeDomotics", "| CENTRE |", wait_time=3000)
        bwd(1050, 1680, "GazeDomotics", "+", wait_time=3000, mode="location", location=(20, 1030))
        bwd(1050, 1680, "GazeDomotics", "| CENTRE |", wait_time=3000)
        bwd(1050, 1680, "GazeDomotics", "+", wait_time=3000, mode="location", location=(840, 1030))
        bwd(1050, 1680, "GazeDomotics", "| CENTRE |", wait_time=3000)
        bwd(1050, 1680, "GazeDomotics", "+", wait_time=3000, mode="location", location=(1660, 1030))
        bwd(1050, 1680, "GazeDomotics", "| CENTRE |", wait_time=3000)
        ...
        bwd(1050, 1680, "GazeDomotics", "| CENTRE |", wait_time=3000)
        bwd(1050, 1680, "GazeDomotics", "| CENTRE |", wait_time=3000)
        bwd(1050, 1680, "GazeDomotics", "FIN", wait_time=3000)
