...
if __name__ == "__main__":
    ...
    Basic_Window_Displayer(screen_height, screen_width, "Test", "Regardez la croix qui va apparaitre", blanc, 1000, "center")
    
    pool = mp.Pool(2)
    OpenFace = pool.map_async(sp.call, ['./OpenFace_runner.sh'])
    
    Basic_Window_Displayer(screen_height, screen_width, "Test", "+", blanc, 1000, "center")
    ...
    Basic_Window_Displayer(screen_height, screen_width, "Test", "Calibration terminee", blanc, 1000, "center")
